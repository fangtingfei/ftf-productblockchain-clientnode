package cn.ftf.productblockchain.clientnode.util;
...
public class RSAUtils {
    ...
    public static void generateKeys(String algorithm, String privateKeyPath, String publicKeyPath) {
        try {
            ...
            String encodePrivateKey = Base64.encodeBase64String(privateKeyEncoded);
            String encodePublicKey = Base64.encodeBase64String(publicKeyEncoded);
            // 保存到文件
    ...
    public static PublicKey getPublicKeyFromString(String algorithm, String publicKeyString) {
        try {
            // 进行Base64解码
            byte[] publicKeyEncoded = Base64.decodeBase64(publicKeyString);
            // 获取密钥工厂
    ...
    public static PrivateKey getPrivateKeyFromString(String algorithm, String privateKeyString) {
        try {
            // 进行Base64解码
            byte[] privateKeyEncoded = Base64.decodeBase64(privateKeyString);
            // 获取密钥工厂
            KeyFactory keyFactory = KeyFactory.getInstance(algorithm);
            // 获取私钥
